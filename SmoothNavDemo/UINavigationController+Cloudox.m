...
- (void)setNeedsNavigationBackground:(CGFloat)alpha {
    ...
    for (UIView *view in barBackgroundView.subviews) {
        ...
        NSLog(@"111%@", view.class);
        for (UIView *subview in view.subviews) {
            
            NSLog(@"222%@", subview.class);
        }
        
    }
    
    UIImageView *backgroundImageView = [[[[barBackgroundView subviews] objectAtIndex:1] subviews] objectAtIndex:0];// UIImageView
